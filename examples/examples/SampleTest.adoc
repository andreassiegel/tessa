...
|Documented
|Method Link
|link:https://github.com/andreassiegel/tessa/tree/develop/examples/src/test/java/de/andreassiegel/tessa/examples/SampleTest.java#L72-L89[`happyCase1`]
|===
...
|Documented
|Method Link
|link:https://github.com/andreassiegel/tessa/tree/develop/examples/src/test/java/de/andreassiegel/tessa/examples/SampleTest.java#L96-L141[`failureCase1`]
|===
